    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="file" class="form-control" name="file_foto" id="file_foto" placeholder="Foto" required  accept="image/*">
                    <label for="file_foto">Foto</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="deskripsi_foto" id="deskripsi_foto" placeholder="Deskripsi" required>
